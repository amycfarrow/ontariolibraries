### Preamble ###
# Purpose: Importing and cleaning library data for the year 2009
# Author: Amy Farrow
...
data_2009 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2009.csv"), col_names = TRUE)

### Clean data ###
data_2009 <- clean_names(data_2009)
