### Preamble ###
# Purpose: Importing and cleaning library data for the year 2000
# Author: Amy Farrow
...
data_2000 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2000.csv"), col_names = TRUE)

### Clean data ###
data_2000 <- clean_names(data_2000)
