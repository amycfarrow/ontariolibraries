### Preamble ###
# Purpose: Importing and cleaning library data for the year 2019
# Author: Amy Farrow
...
data_2019 <- readr::read_csv(here::here("inputs/data/2019_ontario_public_library_statistics_open_data.csv"), col_names = TRUE)
