### Preamble ###
# Purpose: Importing and cleaning library data for the year 2012
# Author: Amy Farrow
...
data_2012 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_2012_open_data_may_22_2015_csv_final_9.csv"), col_names = TRUE)

### Clean data ###
data_2012 <- clean_names(data_2012)
