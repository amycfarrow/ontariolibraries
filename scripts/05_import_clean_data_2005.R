### Preamble ###
# Purpose: Importing and cleaning library data for the year 2005
# Author: Amy Farrow
...
data_2005 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2005.csv"), col_names = TRUE)

### Clean data ###
data_2005 <- clean_names(data_2005)
