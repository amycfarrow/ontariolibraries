### Preamble ###
# Purpose: Importing and cleaning library data for the year 2013
# Author: Amy Farrow
...
data_2013 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_2013_open_data_may_22_2015_csv_final.csv"), col_names = TRUE)

### Clean data ###
data_2013 <- clean_names(data_2013)
