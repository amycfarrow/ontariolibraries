### Preamble ###
# Purpose: Importing and cleaning library data for the year 2018
# Author: Amy Farrow
...
data_2018 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_open_data_2018.csv"), col_names = TRUE)
