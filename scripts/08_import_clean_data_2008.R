### Preamble ###
# Purpose: Importing and cleaning library data for the year 2008
# Author: Amy Farrow
...
data_2008 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2008.csv"), col_names = TRUE)

### Clean data ###
data_2008 <- clean_names(data_2008)
