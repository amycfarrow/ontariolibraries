### Preamble ###
# Purpose: Importing and cleaning library data for the year 2001
# Author: Amy Farrow
...
data_2001 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2001.csv"), col_names = TRUE)

### Clean data ###
data_2001 <- clean_names(data_2001)
