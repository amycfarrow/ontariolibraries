### Preamble ###
# Purpose: Importing and cleaning library data for the year 2014
# Author: Amy Farrow
...
data_2014 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_2014_open_data_csv_february_17_2016.csv"), col_names = TRUE)

### Clean data ###
data_2014 <- clean_names(data_2014)
