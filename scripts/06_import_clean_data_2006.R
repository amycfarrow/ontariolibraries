### Preamble ###
# Purpose: Importing and cleaning library data for the year 2006
# Author: Amy Farrow
...
data_2006 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2006.csv"), col_names = TRUE)

### Clean data ###
data_2006 <- clean_names(data_2006)
