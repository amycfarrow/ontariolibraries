### Preamble ###
# Purpose: Importing and cleaning library data for the year 2003
# Author: Amy Farrow
...
data_2003 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2003.csv"), col_names = TRUE)

### Clean data ###
data_2003 <- clean_names(data_2003)
