### Preamble ###
# Purpose: Importing and cleaning library data for the year 2017
# Author: Amy Farrow
...
data_2017 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_open_data_july_2019_rev1.csv"), col_names = TRUE)
...
data_2017 <- data_2017 %>%
  select(survey_year_from,
         ...
         c0_2_t_total_print_volumes_held,
         c0_3_3_t_total_e_book_and_e_audio_titles,
         c4_3_03_hoopla,
         c5_1_if_you_provide_e_learning_services_e_g_lynda_com_gale_courses_learning_express_please_state_how_many,
         c5_2_how_many_cardholders_took_e_learning_courses,
...
data_2017 <- data_2017 %>%
  rename(year = survey_year_from,
         ...
         num_print_volumes = c0_2_t_total_print_volumes_held,
         num_e_book_audio_titles = c0_3_3_t_total_e_book_and_e_audio_titles,
