### Preamble ###
# Purpose: Importing and cleaning library data for the year 2004
# Author: Amy Farrow
...
data_2004 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2004.csv"), col_names = TRUE)

### Clean data ###
data_2004 <- clean_names(data_2004)
