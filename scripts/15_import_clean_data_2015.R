### Preamble ###
# Purpose: Importing and cleaning library data for the year 2015
# Author: Amy Farrow
...
data_2015 <- readr::read_csv(here::here("inputs/data/2015_ontario_public_library_statistics_open_data_dec_2017rev.csv"), col_names = TRUE)
...
data_2015 <- data_2015 %>%
  select(survey_year_from,
         ...
         c2_3_3_t_total_no_of_titles_of_e_resources_including_e_books, # no c0_3_3_t_total_e_book_and_e_audio_titles,
         c4_3_03_hoopla,
