### Preamble ###
# Purpose: Importing and cleaning library data for the year 2010
# Author: Amy Farrow
...
data_2010 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2010.csv"), col_names = TRUE)

### Clean data ###
data_2010 <- clean_names(data_2010)
