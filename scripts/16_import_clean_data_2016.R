### Preamble ###
# Purpose: Importing and cleaning library data for the year 2016
# Author: Amy Farrow
...
data_2016 <- readr::read_csv(here::here("inputs/data/ontario_public_library_statistics_open_data_2016.csv"), col_names = TRUE)
