### Preamble ###
# Purpose: Importing and cleaning library data for the year 2007
# Author: Amy Farrow
...
data_2007 <- readr::read_csv(here::here("inputs/data/ontario_library_stats_2007.csv"), col_names = TRUE)

### Clean data ###
data_2007 <- clean_names(data_2007)
